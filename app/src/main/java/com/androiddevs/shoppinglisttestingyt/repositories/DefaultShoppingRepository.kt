...
class DefaultShoppingRepository @Inject constructor(
    ...
    //multiple repositories, so take advantage of interface to define its responsibilities
    ...
    //we return a resource, from our other package
    override suspend fun searchForImage(imageQuery: String): Resource<ImageResponse> {
        return try {
            //use the API query and check status
